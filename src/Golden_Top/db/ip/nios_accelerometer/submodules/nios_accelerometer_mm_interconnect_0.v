...
module nios_accelerometer_mm_interconnect_0 (
	...
	wire  [11:0] cmd_mux_001_src_channel;                                                                   // cmd_mux_001:src_channel -> jtag_uart_avalon_jtag_slave_agent:cp_channel
	...
	wire  [11:0] cmd_mux_002_src_channel;                                                                   // cmd_mux_002:src_channel -> sysid_qsys_0_control_slave_agent:cp_channel
	...
	wire  [11:0] cmd_mux_004_src_channel;                                                                   // cmd_mux_004:src_channel -> onchip_memory_s1_agent:cp_channel
	...
	wire  [95:0] cmd_mux_008_src_data;                                                                      // cmd_mux_008:src_data -> button_s1_agent:cp_data
	...
	wire  [95:0] cmd_mux_009_src_data;                                                                      // cmd_mux_009:src_data -> hex1_s1_agent:cp_data
	wire         cmd_mux_009_src_ready;                                                                     // hex1_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire  [11:0] cmd_mux_009_src_channel;                                                                   // cmd_mux_009:src_channel -> hex1_s1_agent:cp_channel
	...
	wire         cmd_mux_011_src_valid;                                                                     // cmd_mux_011:src_valid -> switch_s1_agent:cp_valid
	wire  [95:0] cmd_mux_011_src_data;                                                                      // cmd_mux_011:src_data -> switch_s1_agent:cp_data
	wire         cmd_mux_011_src_ready;                                                                     // switch_s1_agent:cp_ready -> cmd_mux_011:src_ready
	wire  [11:0] cmd_mux_011_src_channel;                                                                   // cmd_mux_011:src_channel -> switch_s1_agent:cp_channel
	wire         cmd_mux_011_src_startofpacket;                                                             // cmd_mux_011:src_startofpacket -> switch_s1_agent:cp_startofpacket
	wire         cmd_mux_011_src_endofpacket;                                                               // cmd_mux_011:src_endofpacket -> switch_s1_agent:cp_endofpacket
	...
	wire  [95:0] button_s1_agent_rp_data;                                                                   // button_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [95:0] hex1_s1_agent_rp_data;                                                                     // hex1_s1_agent:rp_data -> router_011:sink_data
	...
	wire         switch_s1_agent_rp_valid;                                                                  // switch_s1_agent:rp_valid -> router_013:sink_valid
	wire  [95:0] switch_s1_agent_rp_data;                                                                   // switch_s1_agent:rp_data -> router_013:sink_data
	wire         switch_s1_agent_rp_ready;                                                                  // router_013:sink_ready -> switch_s1_agent:rp_ready
	wire         switch_s1_agent_rp_startofpacket;                                                          // switch_s1_agent:rp_startofpacket -> router_013:sink_startofpacket
	wire         switch_s1_agent_rp_endofpacket;                                                            // switch_s1_agent:rp_endofpacket -> router_013:sink_endofpacket
	...
	wire  [11:0] accelerometer_spi_avalon_accelerometer_spi_mode_slave_burst_adapter_source0_channel;       // accelerometer_spi_avalon_accelerometer_spi_mode_slave_burst_adapter:source0_channel -> accelerometer_spi_avalon_accelerometer_spi_mode_slave_agent:cp_channel
	...
	wire  [11:0] router_002_src_channel;                                                                    // router_002:src_channel -> accelerometer_spi_avalon_accelerometer_spi_mode_slave_rsp_width_adapter:in_channel
	...
	wire  [11:0] accelerometer_spi_avalon_accelerometer_spi_mode_slave_rsp_width_adapter_src_channel;       // accelerometer_spi_avalon_accelerometer_spi_mode_slave_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	...
	wire  [11:0] cmd_mux_src_channel;                                                                       // cmd_mux:src_channel -> accelerometer_spi_avalon_accelerometer_spi_mode_slave_cmd_width_adapter:in_channel
	...
	wire  [11:0] accelerometer_spi_avalon_accelerometer_spi_mode_slave_cmd_width_adapter_src_channel;       // accelerometer_spi_avalon_accelerometer_spi_mode_slave_cmd_width_adapter:out_channel -> accelerometer_spi_avalon_accelerometer_spi_mode_slave_burst_adapter:sink0_channel
	...
	wire         switch_s1_agent_rdata_fifo_src_valid;                                                      // switch_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_011:in_0_valid
	wire  [33:0] switch_s1_agent_rdata_fifo_src_data;                                                       // switch_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_011:in_0_data
	wire         switch_s1_agent_rdata_fifo_src_ready;                                                      // avalon_st_adapter_011:in_0_ready -> switch_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_011_out_0_valid;                                                         // avalon_st_adapter_011:out_0_valid -> switch_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_011_out_0_data;                                                          // avalon_st_adapter_011:out_0_data -> switch_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_011_out_0_ready;                                                         // switch_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_011:out_0_ready
	wire   [0:0] avalon_st_adapter_011_out_0_error;                                                         // avalon_st_adapter_011:out_0_error -> switch_s1_agent:rdata_fifo_sink_error
	...
	nios_accelerometer_mm_interconnect_0_cmd_demux_001 rsp_demux_004 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
